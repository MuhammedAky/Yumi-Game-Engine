#include <yumi/camera.hpp>

namespace yumi {
    Camera::Camera(EngineWindow* window, float fov, float near, float far, float sensitivity, float normalSpeed, float sprintSpeed, glm::vec3 position)
