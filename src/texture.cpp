#include <yumi/texture.hpp>

namespace yumi {
    Texture::Texture(const char* file, const char* type, unsigned int unit) : unit(unit), type(type) {
    ...
    void Texture::texUnit(unsigned int id, unsigned int unit) {
        glUniform1i(id, unit);
    }
